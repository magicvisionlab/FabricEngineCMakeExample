...
MACRO(extension_build)
	...
	ADD_LIBRARY(${FABRIC_EXTENSION_NAME} MODULE ${FABRIC_EXTENSION_CPP_SRCS})
	INCLUDE_DIRECTORIES( "${CMAKE_CURRENT_BINARY_DIR}")

	SET_PROPERTY(TARGET ${FABRIC_EXTENSION_NAME} PROPERTY PREFIX "")

	TARGET_LINK_LIBRARIES( ${FABRIC_EXTENSION_NAME} ${ARGN})

	# set target properties
	SET_TARGET_PROPERTIES( ${FABRIC_EXTENSION_NAME} PROPERTIES COMPILE_FLAGS "${FABRIC_MODULE_CFLAGS}" )
	SET_TARGET_PROPERTIES( ${FABRIC_EXTENSION_NAME} PROPERTIES COMPILE_DEFINITIONS "${FABRIC_MODULE_DEFINES}" )
	SET_TARGET_PROPERTIES( ${FABRIC_EXTENSION_NAME} PROPERTIES LINK_FLAGS "${FABRIC_MODULE_LINKFLAGS}" )
	SET_TARGET_PROPERTIES( ${FABRIC_EXTENSION_NAME} PROPERTIES OUTPUT_NAME ${FABRIC_EXTENSION_NAME}-${FABRIC_BUILD_OS}-${FABRIC_BUILD_ARCH} )

	ADD_CUSTOM_TARGET(create${FABRIC_EXTENSION_NAME}.h COMMAND ${KL2EDK_BINARY} -o ${CMAKE_CURRENT_BINARY_DIR} ${FABRIC_EXTENSION_KL_SRCS})
	ADD_DEPENDENCIES(${FABRIC_EXTENSION_NAME} create${FABRIC_EXTENSION_NAME}.h)

	INSTALL(TARGETS ${FABRIC_EXTENSION_NAME} 
